...
const Insights = {
  generate() {
    ...
    if (totalSpend > 0) {
      // Mesmo divisor mínimo usado em forecast.js — evita que um único gasto
      // no dia 1 do mês vire uma "média diária" enganosa e uma projeção absurda.
      const avgDaily = totalSpend / Math.max(day, 5);
