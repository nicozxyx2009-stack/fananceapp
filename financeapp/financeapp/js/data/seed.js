...
const Seed = {
  createInitialData() {
    ...
    return {
      ...
      recurring: [
        { id: "rec_1", name: "Aluguel", category: "Moradia", amount: 700.0, frequency: "Mensal", billingDay: relDay(0.47), accountId, active: true },
        { id: "rec_2", name: "Internet Fibra", category: "Moradia", amount: 100.0, frequency: "Mensal", billingDay: relDay(0.88), accountId, active: true },
        { id: "rec_3", name: "Netflix", category: "Assinaturas", amount: 39.9, frequency: "Mensal", billingDay: relDay(0.59), accountId, active: true },
        { id: "rec_4", name: "Spotify", category: "Assinaturas", amount: 21.9, frequency: "Mensal", billingDay: relDay(0.88), accountId, active: true },
        { id: "rec_5", name: "Academia", category: "Saúde", amount: 80.0, frequency: "Mensal", billingDay: relDay(0.94), accountId, active: true },
      ],
      ...
      // Log leve de notificações (ex: "Transação adicionada"). Limitado a
      // 20 itens mais recentes — não é uma segunda fonte de dados financeiros,
      // só um histórico de eventos pra exibir como toast/feedback.
      notifications: [],
    };
  },
};
